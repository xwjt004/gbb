...
function mapApiPackage(p: BackendPackageListItem): Package {
  return {
    ...
    packageServices: (p as any).packageServices || [],
    groupBuyDescription: (p as any).groupBuyDescription || '',
    groupMinCount: (p as any).groupMinCount,
    groupPrice: (p as any).groupPrice,
    posterTitle: (p as any).posterTitle || '',
    posterContent: (p as any).posterContent || '',
    posterBackground: (p as any).posterBackground || '',
    posterImages: (p as any).posterImages || [],
    maxBookings: 0,
...
export const packageService = {
  ...
  async getPackageDetail(id: string|number) {
    ...
    const mapped: Package = {
      ...
      groupBuyDescription: data.groupBuyDescription || '',
      groupMinCount: data.groupMinCount,
      groupPrice: data.groupPrice,
      posterTitle: data.posterTitle || '',
      posterContent: data.posterContent || '',
      posterBackground: data.posterBackground || '',
