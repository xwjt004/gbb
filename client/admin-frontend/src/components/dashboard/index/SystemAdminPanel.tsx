        ...
        <Col span={12}>
          <Card size="small" hoverable>
            <div style={{ textAlign: 'center' }}>
              ...
              <div style={{ fontWeight: 'bold' }}>员工管理</div>
              <Text type="secondary" style={{ fontSize: 12 }}>员工权限、角色配置</Text>
              <div style={{ marginTop: 8 }}><Button type="primary" size="small" block onClick={() => message.info('跳转到员工管理')}>管理</Button></div>
            </div>
          </Card>
        </Col>
        <Col span={12}>
